...
ZONES: list[ZoneEntry] = [
    ...
    ZoneEntry("Norgos' Lair",           "norgos-lair",        1, floors=1, boss="Norgos, the Frozen",      optional=True,  notes="Spawns after clearing Trollmire."),
    ...
    ZoneEntry("Rhaloren Camp",          "rhaloren-camp",      1, floors=1, boss="Rhaloren Inquisitor",      optional=True,  notes="Shaloren quest chain only."),
    ...
    # ── Tier 2 — Levels 10–20 ─────────────────────────────────────────────
    ZoneEntry("The Maze",               "maze",               2, floors=7, boss="Minotaur of the Labyrinth", notes="Find the Minotaur on the bottom floor."),
    ZoneEntry("Sandworm Lair",          "sandworm-lair",      2, floors=4, boss="Sandworm Queen",           notes="Bottom floor leads to Ancient Elven Ruins."),
    ...
    ZoneEntry("Lumberjack Village",     "lumberjack-village", 2, floors=1, optional=True,                  notes="Spawns from a random quest just north of Last Hope."),
    ...
    # ── Tier 3 — Levels 20–30 ─────────────────────────────────────────────
    ZoneEntry("Dreadfell",              "dreadfell",         3, floors=10, boss="Grand Corruptor",         notes="Main story zone. Long — bring consumables."),
    ZoneEntry("Lake of Nur",            "lake-nur",          3, floors=4,                                  notes="Accessed from bottom of Old Forest."),
    ZoneEntry("Ancient Elven Ruins",    "ancient-elven-ruins",3, floors=5,                                 notes="Accessed from bottom of Sandworm Lair."),
    ZoneEntry("Abashed Expanse",        "abashed-expanse",   3, floors=3,                                  notes="East side. High-level encounters."),
    ZoneEntry("Mark of the Spellblaze", "mark-spellblaze",   3, floors=1, boss="Spellblaze Crystal",       notes="Triggered by world event."),
