...
from gui.theme import BG, BORDER, GREEN, YELLOW, SUBTEXT0, SUBTEXT1, SURFACE0, SURFACE1, SURFACE2, TEXT, RED
...
class _ZoneRow(QFrame):
    def __init__(self, zone: ZoneEntry, parent: QWidget | None = None) -> None:
        ...
        self._zone = zone
        self.setStyleSheet(
            f"QFrame {{ background: {SURFACE0}; border: 1px solid {BORDER}; border-radius: 4px; }}"
        )
        ...
        self._dot.setStyleSheet(
            f"background: {_DOT_UNVISITED}; border-radius: 6px;"
        )
        ...
        self._name_lbl.setStyleSheet(
            f"font-size: 13px; font-weight: 700; color: {SUBTEXT0};"
        )
    ...
    def update_status(
        ...
        self._name_lbl.setStyleSheet(
            f"font-size: 13px; font-weight: 700; color: {name_color};"
        )
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        for tier_num in sorted(tiers):
            ...
            header.setStyleSheet(
                f"font-size: 12px; font-weight: 700; color: {SUBTEXT0};"
                f" letter-spacing: 1px; padding: 10px 0 4px 2px;"
            )
